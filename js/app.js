var myapp = {};
  ...
  StackMob.init({
    ...
    publicKey: "29c28b6d-543d-49e5-8a3f-80abce3f6ab2",
    apiVersion: 0
  });
...
(function($){
  ...
  myapp.User = StackMob.Model.extend({
      schemaName: 'user',
  });
  ...
  myapp.LoginView = Backbone.View.extend({
...
/*
  ...
  myapp.AppRouter = Backbone.Router.extend({
      ...
      login:function () {
          this.changePage(new myapp.LoginView({collection:myapp.todos, router:this}),false);
      },
